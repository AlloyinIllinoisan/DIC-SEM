...
f = open("C:\\xCorrel\\IncoDIC_Step1.bat", "w+") #Change the Name and the directory below
f.write("echo off\n")
...
for i in range(1,b+1):
    for j in range(1,n+1):
        f.write("start /wait XCorrel_V9.11a.exe D:\\CollaborativeProjects\\2022_718MicroVolume\\HRDIC\\AlignedImages_step1\\IMAFile_p%s_%s.ima\n" % (i,j))
    print('file done')
f.close()
