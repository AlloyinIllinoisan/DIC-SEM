...
L2 = '''call {}
cd "{}"
python NewSorter.py'''.format(PythonDirectory,PythonScriptsDirectory)
lemon.append(L2)
...
California.to_csv(BatchFileMacrosDirectory+'/NewSorter_Batch.bat', index=False, header=False, sep='\t', quoting=csv.QUOTE_NONE, escapechar = '\t')
