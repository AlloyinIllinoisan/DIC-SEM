...
L2 = '''call {}
cd "{}"
python Finished_ForCollaborators.py'''.format(PythonDirectory,PythonScriptsDirectory)
lemon.append(L2)
...
California.to_csv(BatchFileMacrosDirectory+'/Finished_Batch.bat', index=False, header=False, sep='\t', quoting=csv.QUOTE_NONE, escapechar = '\t')
