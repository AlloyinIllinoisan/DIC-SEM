...
# f = open("C:\\xCorrel\\Hayes_step3.bat", "w+") #Change the Name and the directory below
# f.write("echo off\n")
# f.write("title calculation HDIC\n")
# f.write("echo start calcul\n")
# f.write("pause\n")
...
#         f.write("start /wait XCorrel_V9.11a.exe E:\\2023_Hayes\\Hayes_04\\AlignedImages_step3\\IMAFile_p%s_%s.ima\n" % (i,j))
#     print('file done')
# f.write("call XCorrel_Finished_Hayes.bat")
# f.close()
        
#This returns all files in the recalculation directory to their extension folders      
