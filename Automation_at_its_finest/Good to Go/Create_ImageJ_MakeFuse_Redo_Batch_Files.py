...
# California.to_csv('{}'.format(BatchFileMacrosDirectory)+'/ImageJ_Fusion_BlN_Redo.bat', index=False, header=False, sep='\t', quoting=csv.QUOTE_NONE, escapechar = '\t')
...
# strawberryConcat.to_csv('{}'.format(BatchFileMacrosDirectory)+'/ImageJ_Fusion_GrX_Redo.bat', index=False, header=False, sep='\t', quoting=csv.QUOTE_NONE, escapechar = '\t')
...
huckleberry = []
huckleberryconcat = pd.concat([strawberryConcat,California])
huckleberryconcat.to_csv('{}'.format(BatchFileMacrosDirectory)+'/ImageJ_Fusion_BlN_GrX_Redo.bat', index=False, header=False, sep='\t', quoting=csv.QUOTE_NONE, escapechar = '\t')


yag = yagmail.SMTP('{}'.format(WorkStationEmail), '{}'.format(Password))

contents = ['Commence with Final Steps']
