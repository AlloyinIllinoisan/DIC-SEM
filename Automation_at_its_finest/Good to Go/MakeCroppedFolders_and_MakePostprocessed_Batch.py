...
L2 = '''call {}
cd "{}"
python MakeCroppedFolders_and_MakePostprocessed.py'''.format(PythonDirectory,PythonScriptsDirectory)
lemon.append(L2)
...
California.to_csv(BatchFileMacrosDirectory+'/MakeCroppedFoldersandMakePostprocessed_batch.bat', index=False, header=False, sep='\t', quoting=csv.QUOTE_NONE, escapechar = '\t')
