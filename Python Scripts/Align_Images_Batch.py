...
cd "{}"
python Align_Images.py'''.format(PythonScriptsDirectory)
lemon.append(L2)
...
California.to_csv(BatchFileMacrosDirectory+'/Align_Images_Batch.bat', index=False, header=False, sep='\t', quoting=csv.QUOTE_NONE, escapechar = '\t')
