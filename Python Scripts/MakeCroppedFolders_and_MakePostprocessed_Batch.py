...
cd "{}"
python MakeCroppedFolders_and_MakePostprocessed.py'''.format(PythonScriptsDirectory)
lemon.append(L2)
...
California.to_csv(BatchFileMacrosDirectory+'/MakeCroppedFoldersandMakePostprocessed.bat', index=False, header=False, sep='\t', quoting=csv.QUOTE_NONE, escapechar = '\t')
